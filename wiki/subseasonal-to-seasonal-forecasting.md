...
- **全球迭代模型**：FourCastNetV2、PanguWeather、[[graphcast|GraphCast]] 等中期预报模型通过自回归迭代扩展到 S2S 尺度，但累积误差严重
...
| 尺度 | 时间范围 | 核心驱动力 | 代表方法 |
|:-----|:---------|:-----------|:---------|
| 中期预报 | ≤15 天 | 初始条件 | PanguWeather, [[graphcast|GraphCast]] |
