...
- [[precipitation-nowcasting|降水临近预报]]同样面对极端降水事件。QCGS（ICLR 2026）提出无雷达的 AWS-卫星融合降水场生成框架[^src-qcgs]；[[rainpro|RainPro-8]]（ICLR 2026）在 8h 窗口内提供校准的多强度概率预报，可辅助极端降水预警决策[^src-rainpro].
