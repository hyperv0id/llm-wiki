...
[[timi|TiMi]] **[[mmoe|MMoE]]**：TMoE 文本门控 + SMoE 序列门控；消融优于标准 MoE / Cross-Attention。换 FFN；PatchTST+MMoE 平均 MSE −18.2%。标签 [[non-fusion-guidance|Non-Fusion Guidance]][^src-timi]。
