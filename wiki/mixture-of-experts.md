...
- 在 [[source-fast-long-horizon-forecasting|FaST]] 中，使用 **Gated Linear Units (GLU)** 作为 experts，相比传统 FFN 有更好的并行性
...
[[source-fast-long-horizon-forecasting|FaST]] 首次将 MoE 应用于大规模长视野时空图预测：
- 使用 HA-MoE 进行时间压缩输入
